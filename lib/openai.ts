...
/**
 * Lazily instantiate the OpenAI client. Instantiating at module load makes
 * `next build` fail during page-data collection when OPENAI_API_KEY is absent
 * (e.g. CI builds without secrets), so we defer creation until first use.
 */
