 ...
 * markup/phishing-link injection into messages delivered to the admin/users). */
...
/** Strip CR/LF so user text can't break the Subject header. */
...
export async function sendAccessRequestNotification(
  ...
  await resend.emails.send({
    from: FROM,
    to: ADMIN_EMAIL,
    subject: oneLine(`New access request from ${name}`),
    html: `
