...
export default function AgentSettingsPage() {
  ...
  useEffect(() => {
    ...
    if (params.get('connected')) setBanner({ kind: 'ok', text: 'Google connected (Gmail + Calendar).' });
  ...
  return (
    <div className="mx-auto max-w-2xl space-y-10 px-4 py-10">
      ...
      <section className="space-y-3">
        ...
        <p className="text-xs text-muted">
          Connect apps so your agent can act on your behalf — read your email and calendar, and report
          on your social-media activity. You control how much each one is allowed to do.
        </p>
